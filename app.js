...
app.use('/contestants', ensureAuthenticated, contestantRoutes);
app.use('/supervisors', ensureAuthenticated, supervisorRoutes);
app.use('/competitions', ensureAuthenticated, competitionRoutes);
app.use('/scores', ensureAuthenticated, scoreRoutes);
